...
import { measuringPointsRouter } from "@/modules/measuring-points/measuring-point.routes";
import { meterCountersRouter } from "@/modules/meter-counters/meter-counter.routes";
...
moduleRouter.use("/measuring-points", measuringPointsRouter);
moduleRouter.use("/meter-counters", meterCountersRouter);
...
moduleRouter.use("/assignments", assignmentsRouter);
